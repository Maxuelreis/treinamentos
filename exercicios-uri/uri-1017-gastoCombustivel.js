 ...
 * Para efetuar o cálculo, deve-se fornecer o tempo gasto na viagem 
...
O primeiro é o tempo gasto na viagem (em horas) e 
...
console.log(parseFloat(consumo).toFixed(3));