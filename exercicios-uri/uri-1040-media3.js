...
let valor1 = parseFloat(values.shift( ));
let valor2 = parseFloat(values.shift( ));
let valor3 = parseFloat(values.shift( ));
let valor4 = parseFloat(values.shift( ));

let exame = parseFloat(lines.splice([1]));

let media = ((valor1*2)+(valor2*3)+(valor3*4)+valor4)/(2+3+4+1);
